    ...
    if (title.isNotEmpty && content.isNotEmpty) {
      if (_pickedFile != null) {
        ...
        try {
          ...
          Timestamp startTime = Timestamp.fromDate(createDate.toDate().add(Duration(minutes: 1)));
          Timestamp endTime = Timestamp.fromDate(startTime.toDate().add(Duration(minutes: 1)));
