    ...
    if (title.isNotEmpty && content.isNotEmpty) {
      if (_pickedFile != null) {
        ...
        try {
          ...
          Timestamp startTime = Timestamp.fromDate(createDate.toDate().add(Duration(seconds: 30)));
          Timestamp endTime = Timestamp.fromDate(startTime.toDate().add(Duration(seconds: 30)));
